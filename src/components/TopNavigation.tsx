...
export default function TopNavigation({
  ...
  return (
    <div
      className={`fixed left-0 right-0 top-[90px] z-[99] h-[58px] w-full ${
    ...
    >
      <div className="mx-auto h-full w-full max-w-[1200px] px-2 sm:px-0">
        <div className="grid h-full w-full grid-cols-3 items-center gap-1 rounded-xl border border-slate-700 bg-[#111827] px-1 sm:gap-2 sm:px-2">

          {/* DCF CALCULATOR */}
          <button
            type="button"
            onClick={() => setActiveTab("calculator")}
            className={`flex h-[44px] min-w-0 items-center justify-center gap-1 rounded-lg px-2 text-center transition-all sm:gap-2 sm:px-5 ${
