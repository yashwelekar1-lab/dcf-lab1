...
export default function IntelligenceStoryIntro() {
  ...
  const whiteOpacity =
    ...
    /* ============================================================
     ...
     0.96 - 0.99
       PURE WHITE. Nothing else is visible.

     0.99+
       Only after the user scrolls through the white pause,
       the real analysis page starts appearing in succession.

     No vertical movement. Only opacity and blur change.
     ============================================================ */
